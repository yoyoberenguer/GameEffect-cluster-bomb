...
float damped_oscillation(double t)
{
...
// c structure for returning data concerning
// missile trajectory and collision coordinates
struct mla_pack
{
   struct vector2d vector;
   struct vector2d collision;
};
